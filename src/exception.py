...
def get_error_message_detail(self,error_message,error_detail:sys):
    _,_,exc_tb = error_detail.exc_info()
    filename = exc_tb.tb_frame.f_code.co_filename
    error_message = f'Error occured in file named {filename} at line no. {exc_tb.tb_lineno} is {error_message}.'
